...
const EmployeeDetails = ({ onSaveSuccess, employeeId }) => {
  ...
  const handleSave = async () => {
    try {
      ...
      try {
        const res = await axiosInstance[method](url, combinedData, { headers });
        ...
        if (res.status === 200 || res.status === 201) {
          ...
          if (
            EmployeeDetails &&
            typeof EmployeeDetails.resetForm === "function"
          ) {
            EmployeeDetails.resetForm();
          }

          if (
            workDetailsRef.current &&
            typeof workDetailsRef.current.resetForm === "function"
          ) {
                ...
                <div className={`${styles.formContainer} ${styles.cardBody}`}>
                  <div className={styles.formGroup}>
                    ...
                    <input
                      type="text"
                      name="name"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.name}
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input
                      ...
                      name="address"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.address}
                      className={styles.formControl}
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input
                      ...
                      name="phone"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.phone}
                      className={styles.formControl}
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <select
                      name="gender"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.gender}
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input
                      ...
                      name="nationality"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.nationality}
                      className={styles.formControl}
                  ...
                  <div className={styles.formGroup}>
                    <label className={styles.formLabel}>
                      <FaCalendarAlt className={styles.inputIcon} /> تاريخ
                      الميلاد
                    </label>
                    <input
                      type="date"
                      name="dob"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.dob}
                      className={styles.formControl}
                    />
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <input
                      ...
                      name="ssn"
                      onChange={EmployeeDetails.handleChange}
                      value={EmployeeDetails.values.ssn}
                      className={styles.formControl}
