...
import { getHolidays, addHoliday, deleteHoliday, updateHoliday } from "../../apis/officialholidays";
...
const HolidaysPage = () => {
  ...
  const handleUpdate = async (updatedHoliday) => {
    try {
      ...
      const sendData = { name: formattedHoliday.name, date: formattedHoliday.date, type: formattedHoliday.type, duration: formattedHoliday.duration, description: formattedHoliday.description, repeated: formattedHoliday.repeated };
  ...
  return (
    <div className="container py-4" style={{ backgroundColor: '#FFFFFF' }}>
      <h2 className="text-center mb-4" style={{ color: '#003366' }}>نظام إدارة الإجازات الرسمية</h2>
      <h6 className="text-center mb-4" style={{ color: '#004080' }}> إدارة العطل الرسمية والوطنية والدينية </h6><div className="row mb-4 text-center">
  <div className="col-md-4">
    <div className="card" style={{ backgroundColor: 'rgba(255, 193, 7, 0.85)', color: '#FFF' }}>
  ...
  <div className="col-md-4">
    <div className="card" style={{ backgroundColor: 'rgba(40, 167, 69, 0.85)', color: '#FFF' }}>
      <div className="card-body">
        <h5 className="card-title d-flex justify-content-center align-items-center gap-2">
  ...
  <div className="col-md-4">
    <div className="card" style={{ backgroundColor: 'rgba(0, 123, 255, 0.85)', color: '#FFF' }}>
      <div className="card-body">
        <h5 className="card-title d-flex justify-content-center align-items-center gap-2">
      ...
      <div className="row">
        <div className="col-md-4 order-md-1">
          <HolidayForm onAdd={handleAdd} onUpdate={handleUpdate} editHoliday={editHoliday} holidays={holidays} />
        </div>
        <div className="col-md-8 order-md-2">
          <HolidayList holidays={holidays} onDelete={handleDelete} onEdit={handleEdit} />
        </div>
      </div>
    </div>
  );
