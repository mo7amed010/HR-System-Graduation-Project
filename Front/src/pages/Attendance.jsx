...
function Attendance() {
  ...
  const fetchAttendance = async () => {
    try {
      ...
      if (searchTerm.trim())
        params.push(`employeeName=${encodeURIComponent(searchTerm.trim())}`);
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="modal-body">
                  {!isEditing && (
                    <>
                      <div className="mb-3">
                        ...
                        {errors.employeeId && (
                          <small className="text-danger">يجب اختيار موظف</small>
                        )}
                      </div>
                      <div className="mb-3">
                        ...
                        />
                        {errors.date && (
                          <small className="text-danger">يجب إدخال التاريخ</small>
                        )}
                      </div>
                    </>
                  )}
                  <div className="mb-3">
                    ...
                    />
                    {errors.checkIn && (
                      <small className="text-danger">يجب إدخال وقت الدخول</small>
                    )}
                  </div>
                  <div className="mb-3">
                    ...
                    />
                    {errors.checkOut && (
                      <small className="text-danger">يجب إدخال وقت الخروج</small>
                    )}
                  </div>
                </div>
...
const StatCard = ({ icon, label, value, color, iconColor }) => (
  <div className="col-md-3 mb-2">
    <div
      className="p-3 rounded shadow d-flex flex-column align-items-center"
